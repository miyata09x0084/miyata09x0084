...
| [slide-pilot](https://github.com/miyata09x0084/slide-pilot) | A proof-of-concept on putting LangGraph in end users' hands — a multimodal PDF→slides→narrated-video workflow wrapped in a real web app with auth, streaming, and async jobs. |
